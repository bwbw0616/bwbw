 ...
 *			-> servlet-name
 *			-> url-pattern
 *  5. WAS restart (auto-reload 설정 시 생략 가능)
 *  
 *  ** Web Application Server, Web Container, Servlet Container
 *  	container ?? 컴포넌트의 생명 주기 관리자.
 *  	Servlet Container ?? servlet 의 생명 주기 관리자. -> 생명주기 관리 내에서 callback을 호출.
...
public class DescServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		super.service(req,resp);	//http요청의 method(7)를 파악하고 해당 callback을 호출
